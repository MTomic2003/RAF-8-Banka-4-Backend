    ...
    "paths": {
        ...
        "/api/peer-otc/negotiations": {
            ...
            "post": {
                ...
                "description": "The authenticated user becomes the buyer. The request is\nforwarded to the seller's bank via §3.2; on success the\nauthoritative id assigned by the peer is returned.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreatePeerNegotiationRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "502": {
                        "description": "Peer unreachable or returned non-2xx",
                        "schema": {
                            "$ref": "#/definitions/errors.AppError"
                        }
                    }
        ...
        "/api/peer-otc/negotiations/{rn}/{id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/peer-otc/negotiations/{rn}/{id}/counter": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Counter terms",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CounterPeerNegotiationRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.PublicStock"
                            }
                        }
                    },
                    "401": {
        ...
        "/api/peer-otc/user/{rn}/{id}": {
            "get": {
                ...
                "description": "Resolves {rn, id} into the owning bank's display name and the\nuser's display name. When rn is ours the lookup is local;\notherwise §3.7 is called on the owning peer bank.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Owning bank routing number",
                        "name": "rn",
                        "in": "path",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "dto.OtcNegotiationView": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "ongoing | accepted | cancelled | expired",
                    "type": "string"
                },
                "updatedAt": {
                    "type": "string"
        ...
        "dto.PublicStock": {
            ...
            "properties": {
                "sellers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.PublicStockSeller"
                    }
                },
                "stock": {
                    "$ref": "#/definitions/dto.StockDescription"
